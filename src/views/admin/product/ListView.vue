<template>
    <AdminLayout>
        ...
        <div class="flex gap-2 items-center">
            <div class="flex-1">
                <input v-model="adminProductStore.filter.search" type="text" placeholder="Type here" class="input input-bordered w-full max-w-xs" />
            </div>
            <div class="flex-1">
            ...
            <div class="flex-1 mb-5">
                ...
                <div class="join ">
                    ...
                    :class="adminProductStore.filter.status === 'all' ? 'btn-active' : ''"
                    >ALL</button>
                    ...
                    :class="adminProductStore.filter.status === 'closed' ? 'btn-active' : ''"
                    >CLOSE</button>
                </div>
            </div>
            <div class="flex-1 mb-5">
                ...
                <div class="join">
                    <button class="btn join-item ml-8"
